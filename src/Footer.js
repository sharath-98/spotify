...
function Footer() {
  ...
  const [{clicked_details, recent_details, discover_weekly, songName, songArtist}, dispatch] = useDataLayerValue();
  return (
    <div className='footer'>
      <div className='footer_left'>
        {clicked_details.length!=0 ? ( <img className='songLogo' src={clicked_details?.images[0].url}  alt="" />):
